...
PRESS_SPACE_TEXT = SMALL_FONT.render("Press Space to continue...", False, "white")
PRESS_SPACE_TEXT_RECT = PRESS_SPACE_TEXT.get_rect(midtop=(GAME_OVER_TEXT_RECT.midbottom[0], GAME_OVER_TEXT_RECT.midbottom[1] + 20))
